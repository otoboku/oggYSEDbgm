...
{
	CString s; s=m_szTitle;
	return s;
}

void CId3tagv1::SetTitle(char* title)
{
	char *buf = title;
	m_bEnable = TRUE;
...
{
	CString s; s=m_szArtist;
	return s;
}

void CId3tagv1::SetArtist(char* artist)
{
//#ifdef UNICODE
...
{
	CString s; s=m_szAlbum;
	return s;
}

void CId3tagv1::SetAlbum(char* album)
{
//#ifdef UNICODE
...
{
	CString s; s=m_szYear;
	return s;
}

void CId3tagv1::SetYear(char* year)
{
//#ifdef UNICODE
...
void CId3tagv1::SetGenre(char* szGenre)
{
	m_bEnable = TRUE;
	for(int i=0; i<256; i++)
	{
...
{
	CString s; s=m_szComment;
	return s;
}

void CId3tagv1::SetComment(char* comment)
{
//#ifdef UNICODE
