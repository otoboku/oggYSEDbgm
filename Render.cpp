...
BOOL CRender::OnInitDialog() 
{
	...
	m_tooltip.AddTool(GetDlgItem(IDC_CHECK32),_T("kpi SPC/NEZplug++の音量を1.5倍にします。"));
	m_tooltip.AddTool(GetDlgItem(IDC_CHECK33),_T("kpi SPC/NEZplug++の音量を2倍にします。"));
	m_tooltip.AddTool(GetDlgItem(IDC_CHECK34),_T("kpi SPC/NEZplug++の音量を2.5倍にします。"));
	m_tooltip.AddTool(GetDlgItem(IDC_CHECK35),_T("kpi SPC/NEZplug++の音量を等倍にします。"));
	m_tooltip.AddTool(GetDlgItem(IDC_CHECK36),_T("kpi SPC/NEZplug++の音量を3倍にします。"));
	...
	m_tooltip.AddTool(GetDlgItem(IDC_CHECK42),_T("kpiの音量を1.5倍にします。"));
